...
本模块负责生成PRISMA流程图，用于展示系统评价文献筛选过程。

PRISMA (Preferred Reporting Items for Systematic Reviews and Meta-Analyses)
是系统评价和荟萃分析的标准报告指南，其流程图展示了文献筛选的完整流程。

核心功能:
    1. PDF格式输出：使用ReportLab生成高质量PDF
    2. SVG格式输出：生成可缩放矢量图形
    3. 统计数据生成：从筛选结果计算PRISMA统计数据
...
使用示例:
    ...
    >>> generator.generate(
    ...     output_path="prisma.pdf",
    ...     database_counts={"pubmed": 100, "wos": 80},
    ...     duplicates_removed=20,
    ...     screened_count=160,
    ...     excluded_count=100,
    ...     excluded_reasons={"不符合纳入标准": 60, "重复": 20},
